...
// dengan menggunakan fungsi isset == mengecek si user ngeklik submit atau belum
...
// jika username dan password salah berikan alert "username dan password salah", dan arahkkan ke halaman login
		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-6 text-center mb-5">
                    ...
                    <?php if (isset($error)) : ?>
                   <p><?php  echo '<h5 style="color: yellow;">' .$error. '</h5>';?>
						<?php endif; ?>
				</div>
			</div>
			<div class="row justify-content-center">
