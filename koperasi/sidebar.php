 ...
 <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index.php?hal=home" class="brand-link">
      <img src="dist/img/R logo.jpeg" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">RajendraSQUAD</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="https://www.instagram.com/deanpramona/" class="d-block">Alnaira Shanata</a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            <a href="index.php?hal=home" class="nav-link active">
